  ...
  head: () => ({
    meta: [
      { title: "Hostylia — Smart Residential Management Platform" },
      {
        name: "description",
        content:
          "One intelligent operating system for hostels, boarding schools, student housing, PGs and co-living. Rooms, fees, attendance, complaints and security in one platform.",
      },
      { property: "og:title", content: "Hostylia — Smart Residential Management Platform" },
      {
        property: "og:description",
        content:
          "Rooms, students, wardens, parents, fees, attendance, complaints and security — unified.",
      },
...
function Hero() {
  return (
    <section className="bg-hero-gradient relative overflow-hidden">
      {/* Building silhouette */}
      <svg
        className="pointer-events-none absolute inset-x-0 bottom-0 h-48 w-full opacity-[0.08]"
      ...
      >
        <path
          fill="#FFFFFF"
          d="M0 200V120h60V90h40v30h40V60h60v60h50V90h60v30h40V40h70v80h40V70h60v50h50V20h80v100h50V80h60v40h40V50h60v70h40V90h60v30h60V60h70v60h40V100h60v20h60V70h60v50h50V80h60v40h40V20h60v100h50V100h60v20h40V60h70v60h50V90h60v30h60V40h70v80h40V100h60V200Z"
        />
      </svg>
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-20 md:px-6 md:py-28 lg:grid-cols-2">
        <div className="animate-fade-up">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <Link
              to="/book-demo"
              className="inline-flex items-center gap-2 rounded-lg bg-gold px-5 py-3 text-sm font-bold text-navy hover:opacity-90"
            >
  ...
  const items = [
    {
      ...
      desc: "PG and student hostel operations, from check-in to checkout.",
    },
    {
      icon: School,
      title: "Built for Boarding Schools",
      desc: "K-12 boarding with warden, parent and academic linkage.",
    },
    {
      icon: GraduationCap,
      title: "Built for Student Housing",
      desc: "Universities, dorms and coaching residences at scale.",
    },
    {
      icon: Network,
      title: "Built for Multi-Property Owners",
      desc: "Portfolio-wide visibility across blocks and cities.",
    },
  ];
  return (
    <section className="border-y border-dark-border bg-section-dark py-20">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <SectionHeading
          eyebrow="Who Hostylia is for"
          title="A trusted residential operations platform"
          desc="Designed for every type of residential property, from a single hostel to a national portfolio."
        />
...
function PropertyHierarchy() {
  ...
  const styleMap: Record<string, string> = {
    vacant:
      "bg-[color-mix(in_oklab,var(--trust-green)_18%,transparent)] border-[color-mix(in_oklab,var(--trust-green)_40%,transparent)] text-[color:var(--trust-green)]",
    occupied:
      "bg-[color-mix(in_oklab,var(--brand-blue)_22%,transparent)] border-[color-mix(in_oklab,var(--brand-blue)_50%,transparent)] text-white",
    maintenance:
      "bg-[color-mix(in_oklab,var(--gold)_22%,transparent)] border-[color-mix(in_oklab,var(--gold)_50%,transparent)] text-gold",
    ...
    <section className="bg-section-dark py-20">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <SectionHeading
          ...
          title="From property down to a single bed"
          desc="Every level mapped, every room tracked, every status visible at a glance."
        />
        ...
        <div className="mt-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          {levels.map((l, i) => (
            <div
              key={l.label}
              className="card-lift relative rounded-2xl border border-dark-border bg-card p-5 text-center"
            >
          ...
          <div>
            ...
            <div className="mt-4 grid grid-cols-4 gap-2 sm:grid-cols-6">
              {rooms.map((s, i) => (
                <div
                  key={i}
                  className={`flex flex-col items-center justify-center gap-1 rounded-lg border p-3 ${styleMap[s]}`}
                >
                  <BedDouble size={16} />
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          <IllustrationCard
            src={inventoryStatus}
            alt="Inventory status — vacant, on hold, occupied and on notice rooms"
          />
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-3 text-base leading-relaxed text-soft-grey">
              ...
              colored grid, and assign tenants in a tap. Hostylia turns your inventory into a live,
              visual control room.
            </p>
          </div>
        </div>
  ...
  const items = [
    {
      ...
      desc: "Multi-property, blocks, floors, rooms and beds in one tree.",
    },
    {
      icon: GraduationCap,
      title: "Student Management",
      desc: "Admission, profile, documents and parent linkage.",
    },
    {
      icon: BedDouble,
      title: "Room & Bed Allocation",
      desc: "Drag-friendly allocation with occupancy rules.",
    },
    {
      icon: UserCog,
      title: "Warden Management",
      desc: "Role-based controls for wardens and supervisors.",
    },
    {
      icon: IndianRupee,
      title: "Fee & Billing",
      desc: "Invoices, receipts, UPI links and dues automation.",
    },
    {
      icon: MessageSquareWarning,
      title: "Complaint Tracking",
      desc: "Raise, assign, resolve with full audit trail.",
    },
    {
      icon: BellRing,
      title: "Parent Communication",
      desc: "Alerts on attendance, fees, gate-pass and notices.",
    },
    {
      icon: ShieldCheck,
      title: "Security & Gate Pass",
      desc: "Entry, exit, visitor and emergency workflows.",
    },
  ];
  return (
    <section className="border-y border-dark-border bg-section-dark py-20">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <SectionHeading
          eyebrow="Complete Feature System"
          title="Everything you need to run residential operations"
        />
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {items.map((it, i) => (
            <FeatureCard
              key={it.title}
              {...it}
              tone={(["teal", "blue", "green", "gold"] as const)[i % 4]}
            />
          ))}
        </div>
      </div>
  ...
  const items = [
    {
      ...
      desc: "Every gate movement recorded with timestamp and pass ID.",
    },
    {
      icon: ScanLine,
      title: "Gate Pass Approval",
      desc: "Multi-level approvals with parent consent flows.",
    },
    {
      icon: BellRing,
      title: "Parent Alerts",
      desc: "Instant SMS, WhatsApp and in-app notifications.",
    },
    {
      icon: UserCheck,
      title: "Visitor Management",
      desc: "Pre-registered visits, check-in with photo capture.",
    },
    {
      icon: Clock,
      title: "Late Entry Tracking",
      desc: "Configurable curfew and exception handling.",
    },
    {
      icon: ShieldAlert,
      title: "Emergency Escalation",
      desc: "One-tap escalation to wardens and management.",
    },
  ];
  return (
    <section className="bg-section-dark py-20">
    ...
    <section className="border-y border-dark-border bg-section-dark py-20">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <SectionHeading
          ...
          title="A transparent flow from raise to resolution"
        />
  ...
  return (
    <section className="bg-section-dark py-20">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 md:px-6 lg:grid-cols-2">
        <div>
          <SectionHeading
            ...
            title="Collect, reconcile and report — automatically"
            align="left"
          />
        ...
        <div className="dark glass-panel rounded-3xl p-5">
          <div className="flex items-center justify-between border-b border-dark-border pb-3">
            ...
            <span className="rounded-full bg-[color-mix(in_oklab,var(--trust-green)_25%,transparent)] px-3 py-1 text-[11px] font-bold text-[color:var(--trust-green)]">
              Live
            </span>
          </div>
          <div className="mt-4 grid grid-cols-3 gap-3 text-center">
            {[
              ...
              <div
                key={s.l}
                className="rounded-xl border border-dark-border bg-[color-mix(in_oklab,var(--navy)_70%,transparent)] p-3"
              >
            ...
            {[
              {
                ...
                amt: "₹12,500",
                st: "Paid",
                c: "text-[color:var(--trust-green)] bg-[color-mix(in_oklab,var(--trust-green)_18%,transparent)]",
              },
              {
                name: "Priya Verma",
                room: "B-104",
                amt: "₹14,200",
                st: "Pending",
                c: "text-gold bg-[color-mix(in_oklab,var(--gold)_18%,transparent)]",
              },
              {
                name: "Aman Khan",
                room: "C-307",
                amt: "₹11,800",
                st: "Overdue",
                c: "text-[#FF8B8B] bg-[color-mix(in_oklab,#E55353_18%,transparent)]",
              },
              {
                name: "Sneha Patel",
                room: "A-118",
              ...
              <div
                key={r.name}
                className="grid grid-cols-[minmax(0,1fr)_auto_auto] items-center gap-3 rounded-lg border border-dark-border bg-[color-mix(in_oklab,var(--navy)_60%,transparent)] px-3 py-2 text-sm"
              >
                ...
                <span className={`rounded-full px-2 py-0.5 text-[10px] font-bold ${r.c}`}>
                  {r.st}
                </span>
              </div>
            ))}
      ...
      <div className="mx-auto mt-16 grid max-w-7xl gap-6 px-4 md:px-6 lg:grid-cols-2">
        <IllustrationCard
          src={collectionChart}
          alt="Collection report chart with pending and received amounts"
        />
        <IllustrationCard
          src={duesLock}
          alt="Secure resident dues card with rent and maintenance line items"
        />
      </div>
    </section>
  );
...
function RoleDashboards() {
  const items = [
    { icon: Briefcase, title: "Owner Dashboard", desc: "Portfolio occupancy, revenue and risk." },
    {
      ...
      desc: "Day-to-day operations across blocks.",
    },
    {
      icon: ShieldCheck,
      title: "Warden Dashboard",
      desc: "Rooms, attendance, complaints, gate pass.",
    },
    {
      icon: Calculator,
      title: "Accountant Dashboard",
      desc: "Collections, ledgers and reconciliations.",
    },
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((it, i) => (
            <FeatureCard
              key={it.title}
              {...it}
              tone={(["blue", "teal", "green", "gold", "teal", "blue"] as const)[i]}
            />
          ))}
        </div>
      </div>
  ...
  const items = [
    {
      ...
      desc: "Auto-tag, prioritize and route to the right team.",
    },
    {
      icon: Wallet,
      title: "AI Fee Reminder Assistant",
      desc: "Personalized nudges across SMS, WhatsApp and email.",
    },
    {
      icon: BarChart3,
      title: "AI Occupancy Insights",
      desc: "Predict turnover and optimize bed allocation.",
    },
    {
      icon: Languages,
      title: "AI Parent Support",
      desc: "24x7 multilingual answers about their child's stay.",
    },
    { icon: Bot, title: "AI Warden Assistant", desc: "Daily briefings and exception summaries." },
    {
      icon: FileBarChart,
      title: "AI Report Generator",
      desc: "Natural-language queries become beautiful reports.",
    },
  ];
  return (
    <section className="bg-section-dark py-20">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <SectionHeading
          eyebrow="Hostylia AI Suite"
          title="AI-powered residential intelligence"
          desc="Models tuned for residential operations, from complaint triage to fee recovery."
        />
        <div className="mt-12 grid items-center gap-8 lg:grid-cols-[1fr_1.1fr]">
          <IllustrationCard
            src={aiInsights}
            alt="AI residential intelligence dashboard with occupancy gauge and predictive insights"
          />
  ...
  const plans = [
    {
      name: "Starter",
      price: "₹115",
      desc: "For single hostels getting started.",
      features: ["Up to 100 beds", "Core operations", "Email support"],
    },
    {
      name: "Professional",
      price: "₹140",
      desc: "For growing properties and small chains.",
      features: ["Unlimited beds", "AI Suite included", "Priority support"],
      featured: true,
    },
    {
      name: "Enterprise",
      price: "Custom",
      desc: "For multi-property owners and institutions.",
      features: ["Multi-property roll-up", "SSO and SLAs", "Dedicated success manager"],
    },
  ];
  return (
    <section className="border-y border-dark-border bg-section-dark py-20">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <SectionHeading
          ...
          desc="Transparent pricing that scales with your residence."
        />
        ...
        <div className="relative overflow-hidden rounded-3xl border border-dark-border bg-gradient-to-br from-card via-background to-background p-10 md:p-14">
          ...
          <div className="relative max-w-2xl">
            ...
            <p className="mt-3 text-base text-soft-grey">
              Book a demo and see how Hostylia can simplify your hostel, boarding or student housing
              operations.
            </p>
            <div className="mt-7 flex flex-wrap gap-3">
              <Link
  ...
  const steps = [
    {
      ...
      items: [
        "Import beds, students and dues",
        "Configure roles and approvals",
        "Train wardens in two sessions",
      ],
    },
    {
      n: "02",
      icon: Settings2,
      eyebrow: "Operate",
      title: "Run every block in one screen",
      desc: "Wardens, managers and owners get a focused view of the same live source of truth.",
      items: [
        "Live occupancy and fee dashboards",
        "Complaint board with SLA timers",
        "Parent app and security workflows",
      ],
    },
    {
      n: "03",
      icon: LineChart,
      eyebrow: "Optimize",
      title: "Compound wins, quarter after quarter",
      desc: "AI surfaces risks early, automates dues and forecasts vacancy so growth never stalls.",
      items: [
        "AI fee recovery and complaint triage",
        "Vacancy forecast 30 days ahead",
        "Portfolio-wide finance roll-ups",
      ],
    },
  ];
  return (
    <section className="bg-section-dark py-20">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <SectionHeading
          ...
          title="From kickoff to AI co-pilot in three moves"
          desc="A clear path from your first call to a residence that runs itself."
        />
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {steps.map((s) => (
            <div
    ...
    <section className="border-y border-dark-border bg-section-dark py-20">
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 md:px-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-3 text-base leading-relaxed text-soft-grey">
            Beds, blocks and floors are live objects — not spreadsheets. Owners see real status from
            anywhere; wardens act on it in the same screen.
          </p>
          <BenefitList
            items={[
