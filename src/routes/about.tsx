...
import { Target, Heart, ShieldCheck, Sparkles, Building2, Rocket, Users, Globe } from "lucide-react";
    ...
    <div className="bg-section-dark">
      ...
      <section className="border-t border-dark-border py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 md:px-6 lg:grid-cols-2">
          <MockOccupancyDashboard />
          <div>
            <div className="text-xs font-semibold uppercase tracking-widest text-gold">Why we built it</div>
            <h3 className="mt-2 text-2xl font-extrabold text-white md:text-3xl">A control room, not a clipboard</h3>
            <p className="mt-3 text-base leading-relaxed text-soft-grey">
              Wardens were drowning in registers. Owners couldn't see what was happening across blocks.
              Parents kept calling for updates. Hostylia replaces every one of those moments with a
              single live view.
            </p>
            <BenefitList items={[
      ...
      <section className="border-t border-dark-border py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 md:px-6 lg:grid-cols-2">
          <div>
            <div className="text-xs font-semibold uppercase tracking-widest text-gold">Operations, simplified</div>
            <h3 className="mt-2 text-2xl font-extrabold text-white md:text-3xl">Complaints close in hours, not days</h3>
            <p className="mt-3 text-base leading-relaxed text-soft-grey">
      ...
      <section className="border-t border-dark-border py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <FeatureCard icon={Rocket} title="2023 · Founded" desc="Jeevijay Technologies starts Hostylia after running a 400-bed pilot." tone="gold" />
            <FeatureCard icon={Users} title="2024 · 10k beds" desc="First multi-city deployments across boarding schools and PGs." tone="teal" />
      ...
      <section className="border-t border-dark-border py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 md:px-6 lg:grid-cols-[1.1fr_1fr]">
          <div>
            <div className="text-xs font-semibold uppercase tracking-widest text-gold">Intelligent by default</div>
            <h3 className="mt-2 text-2xl font-extrabold text-white md:text-3xl">Built with AI in the foundation</h3>
            <p className="mt-3 text-base leading-relaxed text-soft-grey">
