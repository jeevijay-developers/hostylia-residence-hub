  ...
  return (
    <div className="bg-section-dark">
          ...
          <div className="mx-auto max-w-7xl px-4 md:px-6">
            ...
            {gi === 1 && (
              <div className="mt-14 grid items-stretch gap-10 lg:grid-cols-2">
                ...
                <IllustrationCard src={buildingHero} alt="Modern campus residential building at night" className="lg:col-span-2" />
              </div>
            )}
            {gi === 2 && (
              <div className="mt-14 grid items-center gap-10 lg:grid-cols-2">
                <div>
                  <h3 className="text-2xl font-extrabold text-white md:text-3xl">Mission-critical security and audit</h3>
                  <p className="mt-3 text-base text-soft-grey">
                    Institutional residences need verifiable trails. Every entry, exit and
                    approval is logged, time-stamped and exportable.
                  </p>
                  <BenefitList items={[
      ...
      <section className="border-b border-dark-border py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <SectionHeading eyebrow="Operator stories" title="Built with India's best residential operators" />
