    ...
    <div className="bg-section-dark">
      ...
      <section className="py-20">
        ...
        <div className="mx-auto mt-12 grid max-w-7xl items-center gap-10 px-4 md:px-6 lg:grid-cols-2">
          <MockOccupancyDashboard />
          <div>
            <div className="text-xs font-semibold uppercase tracking-widest text-gold">Live occupancy</div>
            <h3 className="mt-2 text-2xl font-extrabold text-white md:text-3xl">See every bed in real time</h3>
            <p className="mt-3 text-base leading-relaxed text-soft-grey">
              We'll walk you through a real residence — occupancy down to the bed, on-notice tracking
              and instant vacancy alerts.
            </p>
            <BenefitList items={[
        ...
        <div className="mx-auto mt-16 grid max-w-7xl items-center gap-10 px-4 md:px-6 lg:grid-cols-2">
          <div>
            <div className="text-xs font-semibold uppercase tracking-widest text-gold">Finance, automated</div>
