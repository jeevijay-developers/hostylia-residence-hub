...
/** Shared KYC approvals card — used on both the Warden daily brief and the
 * Hostel Admin dashboard. Approve/reject write straight to `documents`,
 * gated by RLS ("documents warden update" / "documents admin all"). */
export function KycApprovalQueueCard() {
