...
/**
 * Role-agnostic change-password flow — extracted from the Warden profile
 * route so it can be reused (not duplicated) by other roles' profile pages.
 * Verifies the current password via a re-signin, then updates it.
 */
